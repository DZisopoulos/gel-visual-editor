...
export const setCustomField: NodeDefinition = {
  type: 'set-custom-field', name: 'Set Custom Field', category: 'clarity', color: '#2DD4BF',
  namespaces: ['xog'],
  fields: [
    { key: 'url', label: 'XOG URL', kind: 'text', required: true },
    { key: 'username', label: 'Username', kind: 'text' },
    { key: 'password', label: 'Password', kind: 'text' },
    { key: 'objectCode', label: 'Object type', kind: 'text', required: true, placeholder: 'project' },
    { key: 'instanceCode', label: 'Instance code', kind: 'expression', required: true, placeholder: '${project.id}' },
    { key: 'fieldName', label: 'Custom field name', kind: 'text', required: true, placeholder: 'riskFlag' },
