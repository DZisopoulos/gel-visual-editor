...
export function xogReadPreset(type: string, name: string, object: string, resultVarPlaceholder: string): NodeDefinition {
  return {
    type, name, category: 'clarity', color: '#2DD4BF',
    namespaces: ['xog'],
    fields: [
      ...
      { key: 'resultVar', label: 'Result variable', kind: 'text', required: true, placeholder: resultVarPlaceholder }
    ],
...
export function xogWritePreset(type: string, name: string, payloadPlaceholder: string): NodeDefinition {
  return {
    type, name, category: 'clarity', color: '#2DD4BF',
    namespaces: ['xog'],
    fields: [
      ...
      { key: 'username', label: 'Username', kind: 'text' },
      { key: 'password', label: 'Password', kind: 'text' },
      { key: 'payload', label: 'Payload', kind: 'xml', required: true, placeholder: payloadPlaceholder },
...
export function sqlPreset(type: string, name: string, resultVarPlaceholder: string, sqlPlaceholder: string): NodeDefinition {
  return {
    type, name, category: 'clarity', color: '#2DD4BF',
    namespaces: ['gel', 'sql'],
    fields: [
